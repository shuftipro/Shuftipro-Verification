...
permission_denied   | List of permissions return in callback that user denied.|No|Yes
...
{
  "permission_denied":"1",
  "required_permissions": ["android.permission.CAMERA","android.permission.WRITE_EXTERNAL_STORAGE","android.permission.RECORD_AUDIO"]
}
```
